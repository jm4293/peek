    ...
    <div className={`w-full flex flex-col gap-1 ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          } bg-theme-bg-card/30 dark:bg-[#1f1f22]/30 backdrop-blur-sm text-theme-text-default placeholder:text-theme-text-gray focus:outline-none focus:ring-2 focus:ring-theme-main-color/20 focus:border-theme-main-color transition-all duration-200 shadow-lg shadow-black/5 dark:shadow-black/20`}
